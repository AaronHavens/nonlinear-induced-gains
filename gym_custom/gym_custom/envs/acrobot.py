...
class QAcrobotEnv(core.Env):
    ...
    **REFERENCE:**
    ...
    #: use dynamics equations from the neurips paper or the book
    book_or_nips = "book"
    action_arrow = None
    domain_fig = None
    actions_num = 3
    ...
    def reset(self):
        theta = self.np_random.uniform(low=0, high=2*pi, size=(2,))
        theta_dot = self.np_random.uniform(low=-1, high=1, size=(2,))
